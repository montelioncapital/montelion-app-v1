...
export default function GetStartedPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // 🔥 Si l'utilisateur est déjà à l'étape 10 ou plus,
      // on l'envoie directement sur la version avancée.
      if (step >= 10) {
  ...
  async function handleGetStarted() {
    ...
    // Si l'utilisateur a déjà commencé (step >= 1),
    // on ne réinitialise pas, on l'envoie directement sur /onboarding.
