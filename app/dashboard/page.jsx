...
export default function DashboardPage() {
  return (
    <div className="flex min-h-screen">
      {/* SIDEBAR (plus foncée) */}
      <aside className="w-64 border-r border-slate-900 bg-[#02010a] flex flex-col">
        {/* User info */}
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 text-sm">
          ...
          {[
            ...
            <button
              key={item.label}
              className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-slate-400 hover:bg-slate-900/70 text-sm transition"
            >
              <span className="text-base">{item.icon}</span>
              <span>{item.label}</span>
            </button>
        ...
        <div className="px-3 py-4">
          <button className="w-full rounded-xl border border-red-500/60 text-red-400 px-3 py-2 text-sm font-medium hover:bg-red-500/10 transition">
            Log out
          </button>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col bg-[#020617]">
        ...
        <div className="flex-1 px-10 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-slate-800 bg-[#050816] px-5 py-4">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            {/* Chart */}
            <div className="xl:col-span-2 rounded-2xl border border-slate-800 bg-[#050816] px-5 py-4 flex flex-col">
              ...
              <div className="flex-1 rounded-xl bg-[#020617] px-4 py-4">
            ...
            {/* Quick swap */}
            <div className="rounded-2xl border border-slate-800 bg-[#050816] px-5 py-4 flex flex-col gap-4">
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <div className="flex items-center justify-between rounded-xl bg-[#020617] px-3 py-2">
